  ...
  return (
    <>
      ...
      <main className="flex flex-col justify-center items-center">
        ...
        <section className="w-full mt-10 md:mt-20 bg-slate-700 p-10 bg-opacity-10 flex">
        ...
        <section className="w-full mt-10 p-10 bg-opacity-10 flex justify-center">
          <div className="container flex flex-col">
        ...
        <section className="w-full mt-10 p-10 bg-opacity-10 flex justify-center">
          <div className="container flex flex-col">
            ...
            <p>
              ...
              quality work at a rapid pace. Beyond planning and team management
              I also spent a good deal of my time building software architecture
        ...
        <section className="w-full mt-10 p-10 bg-opacity-10 flex justify-center">
          <div className="container flex flex-col">
            ...
            <p>
              ...
              the code to untangle and organize a “simple project” that grew to
              an overwhelming goliath. Luckily I developed a large kit of tools
              and skills, and had great peers who were willing to point me in
              the right direction when I was running out of rope. Having worked
              on projects with such a wide array of complexities, I also know
              what tools to deploy and when, because sometimes over managing a
              project just slows it down, and other times one can hardly get
              started until everything is covered in post-it notes and
              highlighter marks.
            </p>
          </div>
        </section>
        <section className="w-full mt-10 bg-slate-700 p-10 bg-opacity-10 flex flex-col justify-center">
          <div className="container flex flex-col">
            ...
            <p>
              ...
              problems, help those who are frustrated find a solution, and take
              a lot of heat from people who are angry at their situation without
